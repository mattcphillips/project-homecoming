...
const AboutPage = () => (
  <Layout>
    ...
    <section>
      ...
      <p>I went to New Guineas expecting to find nothing. At 50 one of the youngest people on the team I presumed anywhere I could visit, leave alone my nearly 80 year old host, was accessible enough that the US would have been there decades ago. Instead I found villagers that had quietly taken care of the wrecks and remains of our war dead for 60 years. Subsequent conversations with others in Europe and elsewhere confirmed my conviction that in this topic, the returning of the dead, goodwill and a spirit of cooperation was everywhere among the people. So the question was, if the local population knows of remains, why aren’t they home yet?</p>
      <p>
        <strong>Board Members:</strong>
      </p>
      <ul>
        <li>Keith Phillips – Chair</li>
        <li>Thomas Brauch – CFO</li>
        <li>Jeremy Bramson</li>
        <li>Johnny K. Wang</li>
      </ul>
      <p>
